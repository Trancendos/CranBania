...
function WorkshopTemplates({ templates }: { templates: WorkshopTemplateSummary[] }) {
  return (
...
export default function VisualBoardList() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-8 pt-20">
      ...
      <WorkshopTemplates templates={templates} />

      <CreateBoardForm templates={templates} onCreated={() => void reload()} />
