...
function WorkshopTemplatesSection({
  templates,
}: {
...
function CreateBoardForm({
  ...
  setBoardType: (value: VisualBoardType) => void;
  workshopTemplateId: string;
  setWorkshopTemplateId: (value: string) => void;
  templates: WorkshopTemplateSummary[];
  createBoard: (e: React.FormEvent) => Promise<void>;
}) {
  return (
...
function BoardList({ boards }: { boards: VisualBoard[] }) {
  return (
...
export default function VisualBoardList() {
  ...
  return (
    <div className="mx-auto max-w-4xl p-8 pt-20">
      ...
      <WorkshopTemplatesSection templates={templates} />
      ...
      <CreateBoardForm
        ...
        setWorkshopTemplateId={setWorkshopTemplateId}
        templates={templates}
